    ...
    <main className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        >
          ...
          <span className="font-sans text-xl font-semibold tracking-tight text-foreground">ЗащитиПрофиль</span>
        </button>

        <div className="hidden items-center gap-8 md:flex">
          {["Главная", "Угрозы", "Инструменты", "О проекте", "Тест"].map((item, index) => (
            <button
              key={item}
      ...
      >
        {/* Hero Section */}
        <section className="flex min-h-screen w-full shrink-0 flex-col justify-end px-6 pb-16 pt-24 md:px-12 md:pb-24" style={{ scrollSnapAlign: "start" }}>
          <div className="max-w-3xl">
            <div className="mb-4 inline-block animate-in fade-in slide-in-from-bottom-4 rounded-full border border-foreground/20 bg-foreground/15 px-4 py-1.5 backdrop-blur-md duration-700">
              <p className="font-mono text-xs text-foreground/90">Кибербезопасность в социальных сетях</p>
            </div>
            ...
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                Образовательный портал по безопасности в соцсетях. Интерактивный чек-лист, инструменты проверки и обучающие материалы для каждого.
              </span>
            </p>
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-in fade-in duration-1000 delay-500">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex h-8 w-5 items-start justify-center rounded-full border border-foreground/20 bg-foreground/15 pt-1.5 backdrop-blur-md">
